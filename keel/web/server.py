...
The guarantee is now that **not one of the nine capability-increasing actions in
...
#: `MECHANICAL` steps, and a test still asserts it is disjoint from the nine capability-
