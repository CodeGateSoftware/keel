# keel Phase 3 — Execution, Rails & Agent Loop (confirm mode) — Implementation Plan
...
- Import shared types from `keel.types` / `keel.strategy.rules.base`.
...
**Files:** modify `keel/data/repository.py`; create `keel/strategy/stats.py`; refactor
`keel/strategy/{backtest,paper,promotion,engine}.py` to use the new surface; update/extend their tests.
...
**Files:** Create `keel/execution/sizing.py`, `tests/execution/test_sizing.py`.
...
**Files:** Create `keel/execution/guards.py`, `tests/execution/test_guards.py`.
...
**Files:** Create `keel/execution/executor.py`, `tests/execution/test_executor.py`.
...
**Files:** modify `keel/data/cb_client.py`; extend `tests/data/test_cb_client.py`.
...
**Files:** Create `keel/security/secrets.py`, `tests/security/test_secrets.py`. `uv add cryptography`.
...
**Files:** Create `keel/security/authz.py`, `tests/security/test_authz.py`.
...
**Files:** Create `keel/agent.py`, `tests/test_agent.py`.
...
**Files:** Create `keel/cli.py`, `tests/test_cli.py`. `uv add click`.
