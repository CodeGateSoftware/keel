# keel — Broker Abstraction, LLM Roles & Productization Principles — Design Spec
...
**Relates to:** main spec `2026-07-15-keel-autotrade-design.md` (esp. §5 architecture, §6.4 no-oracle, §14
...
**2.1 The `Broker` port** (`keel/brokers/base.py`) — a narrow interface every adapter implements, all I/O in
...
assumptions into a **`CompliancePolicy` interface** (`keel/compliance/policy.py`), with **`HalalPolicy` as
