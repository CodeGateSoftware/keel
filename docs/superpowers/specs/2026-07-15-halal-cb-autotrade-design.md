# halal-cb (Auto-Trading Agent) — Design Spec

**Date:** 2026-07-15
**Status:** Draft for user review
**Supersedes:** `2026-07-14-halal-cb-design.md` (the preview-only advisory MVP; this spec extends it into an autonomous agent)
...
`halal-cb` is a local Python agent that runs a **riba-free (interest-free), long-only, spot-crypto**
...
- `halal-cb kill` sets `enabled:false` instantly, regardless of mode.
...
Standard-library `sqlite3`, one file `halal_cb.db`, schema in `data/db.py`. Core tables:
