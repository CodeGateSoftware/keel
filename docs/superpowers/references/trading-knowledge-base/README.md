...
| `strategy/rules/` | Parameterized pullback-continuation family; RSI mean-reversion; DCA/dip-buy; **NEW: Donchian channel breakout (trend-following/buy-strength, long-only) = canonical Turtle system — 20-day-high entry / 10-day-low ASYMMETRIC exit + ATR sizing/stops (§27.1); candidate to replace refuted dip-buying**; **NEW Kaufman candidates: KAMA adaptive-trend (ER-driven, for noisy crypto §54.5), volatility-breakout (buy on +k·ATR §54.3), linear-regression-slope trend (§54.11), percentage swing-filter (time-independent §54.12), Raschke First-Cross pullback-in-uptrend (§54.16), ATR/stdev volatility-band (§54.15), mean-reversion partner for high-noise assets (§54.22); authoritative full Turtle spec (S1 profitable-trade filter + correlation unit-caps §54.14)**; deferred (harmonics incl. full Gartley, Fib-inversion, BTC macro-cycle) | §2.1, §3.3, §7.1, §9.3, §12.1, §15.2, **§23.1, §27.1, §54.3, §54.5, §54.11, §54.12, §54.14, §54.15, §54.16, §54.22** |
